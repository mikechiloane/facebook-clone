        ...
        <div className="max-w-6xl h-full mx-auto bg-white p-2">
          ...
          <div className="max-w-5xl h-full mx-auto">
            <div className="flex flex-col space-y-2 mt-3 items-center justify-center pb-3 border-b-2">
              <p className="text-4xl font-bold">Mike Chiloane</p>
              <p className="text-sm text-gray-500">Java Software Engineer</p>
            </div>
              ...
              <div className="flex flex-col space-y-3">
                <div className="flex items-center space-x-2">
                  ...
                  <p>
                    ...
                    <span className="font-semibold">Convergenc3</span>
                  </p>
                </div>
                <div className="flex items-center space-x-2">
                  <span>
                  ...
                  <p>
                    Studiend B.Sc in Computer Science at{' '}
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <p>
                    Lives in <span className="font-semibold">SunnySide</span>
                  </p>
                </div>
                <div className="flex items-center space-x-2">
                  <span>
